...
# # --- Voting Time Settings ---
# VOTING_START = datetime(2025, 5, 23, 12, 0, 0)  # 9:00 AM
# VOTING_END = datetime(2025, 5, 23, 16, 0, 0)   # 12:00 PM
...
# # --- Candidate Information with Aliases and Picture Paths ---
# CANDIDATES_INFO = {
#     'President': {
#         'Prince John ANIGBO': {
#             'alias': 'Prince',
#              'picture': 'picture/prince.jpeg'
#         },
#         'Covenant Olamigoke OLOWO': {
#             'alias': 'Olowo',
#             'picture': 'picture/olowo.jpeg'
#         }
#     },
#     'Vice President': {
#         'Esther OGUNLEYE': {
#             'alias': 'Esther',
#             'picture': 'picture/esther.jpeg'
#         },
#         'Hafsoh K. OGUNNIYI': {
#             'alias': 'OGUNNIYI',
#             'picture': 'picture/OGUNNIYI.jpeg'
#         }
#     },
#     'General Secretary': {
#         'Churchill OLISA': {
#             'alias': 'Winston',
#             'picture': 'picture/olisa.jpeg'
#         }
#     },
#     'Assistant General Secretary': {
#         'Frank Cleave KASIMANWUNA': {
#             'alias': 'Frank',
#             'picture': 'picture/frank.jpeg'
#         },
#         'Ajiserere ODUFISAN': {
#             'alias': 'Ajay',
#             'picture': 'picture/ajay.jpeg'
#         },
#         'George IHEKWABA': {
#             'alias': 'George',
#             'picture': 'picture/georgejpeg'
#         }
#     },
#     'Financial Secretary': {
#         'F\'eyisayo OLATUNJI': {
#             'alias': 'Feyisayo',
#             'picture': 'picture/feyi.jpeg'
#         }
#     },
#     'Treasurer': {
#         'Okikiimole AKINDUSOYE': {
#             'alias': 'Okiki',
#             'picture': 'picture/okikiimole_akindusoye.jpeg'
#         },
#         'Pipolooluwa AYO-PONLE': {
#             'alias': 'Ayo',
#             'picture': 'picture/pipolooluwa_ayo_ponle.jpeg'
#         }
#     },
#     'PRO': {
#         'Joel ATUH': {
#             'alias': 'Joel',
#             'picture': 'picture/joel.jpeg'
#         },
#         'Steaadfast ILEOGBEN': {
#             'alias': 'Steaadfast',
#             'picture': 'picture/steaad.jpeg'
#         },
#         'Victor Folahanmi AKILO': {
#             'alias': 'Reme',
#             'picture': 'picture/reme.jpeg'
#         },
#         'Enoch OGUNTOYE': {
#             'alias': 'Toye',
#             'picture': 'picture/enoch.jpeg'
#         }
#     },
#     'Sports Secretary': {
#         'Nasirudeen Adeshina ALABI': {
#             'alias': 'Nas',
#             'picture': 'picture/nasirudeen_adeshina_alabi.jpeg'
#         },
#         'Ireoluwa OKE': {
#             'alias': '',
#             'picture': 'picture/ireoluwa_oke.jpg'
#         }
#     },
#     'Welfare Secretary': {
#         'Oluwadunmininu IDOWU': {
#             'alias': 'Dunmi',
#             'picture': 'picture/idowu.jpeg'
#         },
#         'Simbiat O. ADUMADEYIN': {
#             'alias': 'BIBIRE',
#             'picture': 'picture/bibi.jpeg'
#         },
#         'Olamiposi latcefat RAJI': {
#             'alias': '',
#             'picture': 'pictures/olamiposi_latcefat_raji.jpeg'
#         }
#     },
#     'Social Secretary': {
#         'Oluwagbotemi Fatiu ADEBAYO': {
#             'alias': '𝐃𝐉 Gecho',
#             'picture': 'pictures/oluwagbotemi_fatiu_adebayo.jpeg'
#         },
#         'Vivian AGWOILE': {
#             'alias': 'Vivian',
#             'picture': 'pictures/vi.jpeg'
#         }
#     }
# }
...
# def load_candidate_image(picture_path):
#     """Load and display candidate image"""
#     try:
...
#             return None
#     except Exception as e:
#         st.warning(f"Could not load image: {picture_path}")
#         return None

# def display_candidate_with_image(name, position, selected_candidate=None):
#     """Display candidate with their picture and alias"""
#     candidate_info = CANDIDATES_INFO.get(position, {}).get(name, {})
#     alias = candidate_info.get('alias', '')
#     picture_path = candidate_info.get('picture', '')
    
#     # Create a container for the candidate
#     with st.container():
#         col1, col2 = st.columns([1, 3])
        
#         with col1:
#             # Display picture if available
#             image = load_candidate_image(picture_path)
#             if image:
#                 st.image(image, width=80, caption=alias)
#             else:
...
#     """Create candidate selection with images"""
#     st.subheader(f"{position}")
    
#     # Create options with aliases
#     options = []
#     for candidate in candidates:
#         candidate_info = CANDIDATES_INFO.get(position, {}).get(candidate, {})
#         alias = candidate_info.get('alias', '')
...
#     # Create columns for candidates with images
#     if len(candidates) <= 2:
...
# def authenticate_user(email, password):
#     """Authenticate user with email and password (case-insensitive password)"""
#     if st.session_state.voter_df.empty:
#         return False, "No voter data available"
...
#             # Voting form with candidate images
#             st.write("---")
...
#                 ['Okikiimole AKINDUSOYE', 'Pipolooluwa AYO-PONLE'], "vote")
            
#             st.write("---")
            
#             # PRO
#             pro = create_candidate_selection("PRO", 
#                 ['Jocl ATUH', 'Steaadfast ILEOGBEN', 'Victor Folahanmi AKILO', 'Enoch OGUNTOYE'], "vote")
...
CANDIDATES_INFO = {
    ...
    'Vice President': {
        ...
        'Hafsoh K. OGUNNIYI': {
            'alias': 'OGUNNIYI',
            'picture': 'pictures/hafsoh_k_ogunniyi.jpg'
        }
    },
    'General Secretary': {
        'Churchill OLISA': {
            'alias': 'Winston',
            'picture': 'pictures/churchill_olisa.jpg'
        }
    },
    'Assistant General Secretary': {
        'Frankcleave KASIMANWUNA': {
            'alias': 'Frank',
            'picture': 'pictures/frankcleave_kasimanwuna.jpg'
        },
        'Ajiserere ODUFISAN': {
            'alias': 'Ajay',
            'picture': 'pictures/ajiserere_odufisan.jpg'
        },
        'George IHEKWABA': {
            'alias': 'George',
            'picture': 'pictures/george_ihekwaba.jpg'
        }
    },
    'Financial Secretary': {
        'F\'eyisayo OLATUNJI': {
            'alias': 'Feyisayo',
            'picture': 'pictures/feyisayo_olatunji.jpg'
        }
    },
    'Treasurer': {
        'Okikiimole AKINDUSOYE': {
            'alias': 'Okiki',
            'picture': 'pictures/okikiimole_akindusoye.jpg'
        }
    },
    'PRO': {
        'Joel ATUH': {
            'alias': 'Joel',
            'picture': 'pictures/jocl_atuh.jpg'
        },
        'Steaadfast ILEOGBEN': {
            'alias': 'Steaadfast',
            'picture': 'pictures/steaadfast_ileogben.jpg'
        },
        'Victor Folahanmi AKILO': {
            'alias': 'Reme',
            'picture': 'pictures/victor_folahanmi_akilo.jpg'
        },
        'Enoch OGUNTOYE': {
            'alias': 'Toye',
            'picture': 'pictures/enoch_oguntoye.jpg'
        }
    },
    'Sports Secretary': {
        'Nasirudeen Adeshina ALABI': {
            'alias': 'Nas',
            'picture': 'pictures/nasirudeen_adeshina_alabi.jpg'
        },
        'Ireoluwa OKE': {
            'alias': '',
            'picture': 'pictures/ireoluwa_oke.jpg'
        }
    },
    'Welfare Secretary': {
        'Oluwadunmininu IDOWU': {
            'alias': 'Dunmi',
            'picture': 'pictures/oluwadunmininu_idowu.jpg'
        },
        'Simbiat O. ADUMADEYIN': {
            'alias': 'BIBIRE',
            'picture': 'pictures/simbiat_o_adumadeyin.jpg'
        },
        'Olamiposi latcefat RAJI': {
            'alias': '',
            'picture': 'pictures/olamiposi_latcefat_raji.jpg'
        }
    },
    'Social Secretary': {
        'Oluwagbotemi Fatiu ADEBAYO': {
            'alias': '𝐃𝐉 Gecho',
            'picture': 'pictures/oluwagbotemi_fatiu_adebayo.jpg'
        },
        'Vivian AGWOILE': {
            'alias': 'Vivian',
            'picture': 'pictures/vivian_agwoile.jpg'
        }
    }
}
...
if 'votes' not in st.session_state:
    st.session_state.votes = {
        ...
        'Assist. General Secretary': {'Frankcleave KASIMANWUNA': 0, 'Ajiserere ODUFISAN': 0, 'George IHEKWABA': 0},
        'Financial Secretary': {'F\'eyisayo OLATUNJI': 0},
        'Treasurer': { 'Pipolooluwa AYO-PONLE': 0},
